  ...
  for file in files:
    ...
    if file.endswith(".swift"):
      ...
      with open(os.path.join(path, file), 'r') as source:
        ...
        replacement_pattern = lambda match: replacement_string(match.group(2), table_name, match.group(10), match.group(14), file)
        ...
        replacement_pattern = lambda match: replacement_string(match.group(2), table_name, match.group(6), match.group(10), file)
        content = re.sub(pattern, replacement_pattern, content, flags = flags)
