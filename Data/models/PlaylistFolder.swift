...
@objc(PlaylistFolder)
final public class PlaylistFolder: NSManagedObject, CRUD {
    ...
    public class func frc(savedFolder: Bool) -> NSFetchedResultsController<PlaylistFolder> {
    ...
    public static func removeFolder(_ folder: PlaylistFolder) {
        folder.delete(context: .new(inMemory: false))
    }
